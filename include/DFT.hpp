...
public :
    ...
    static bool cmpRadius(Cycloid &v1, Cycloid v2) {
        return v1.getRadius() > v2.getRadius();
    }

    static bool cmpFrequency(Cycloid &v1, Cycloid v2) {
        return abs(v1.getFreq()) < abs(v2.getFreq());
    }
    ...
    static void sortByFrequency(std::vector<Cycloid> &cycles) {
        std::sort(cycles.begin(), cycles.end(), Fourier::cmpFrequency);
    }
